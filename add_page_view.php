...
<div class="header">
  <form style="display: inline; background-color: #FE642E" name= "add_page_home" method="post" action="person_page.php">
  <button class="button button1" style="font-size:12px">BACK</button>
  </form>
