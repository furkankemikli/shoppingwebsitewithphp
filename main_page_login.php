...
<div style="background-color: #848484" class="navbar">
  ...
  <a style="background-color: #848484" href="json_login.php">JSON Page</a>  
  <a style="background-color: #848484" href="rss_login.php">RSS Feed</a>
...
$sql = "SELECT id,image, title, category, price, release_date,expiredate FROM adds WHERE expiredate >= CURDATE() ORDER BY release_date  DESC";
         ...
         echo '
			...
			<tr class='.$row['category'].'>
				...
				<td>'
					  ...
					  . $row['price']. "</td><td>"
					  . $row['release_date']. "</td>
					  <td><button type='button' class='button button1 use-address'/>Details</td>
			</tr>
			</tbody>"
		;
	 }
...
$(".use-address").click(function() {
	...
	$.ajax({
    data: 'orderid=' + id,
    url: 'add_page_login.php',
    method: 'POST',
    success: function(msg) {
		//document.write(msg);
		window.location.replace('add_page_login.php?orderid='+id);
